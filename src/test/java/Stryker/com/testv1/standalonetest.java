...
public class standalonetest {
	...
	public static void main(String[] args) {
		...
		Assert.assertTrue(toastMessage.contains("Login Successfully"));
		...
		List<WebElement> items = driver.findElements(By.cssSelector(".cart ul li h3"));
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("toast-container")));
		String toastMessagelogout = driver.findElement(By.id("toast-container")).getText();
		Assert.assertTrue(toastMessagelogout.contains("Logout Successfully"));
